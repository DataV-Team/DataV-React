...
var ScrollRankingBoard = function ScrollRankingBoard(_ref5) {
  ...
  var stateRef = React.useRef(__chunk_3._extends({}, state, { avgHeight: 0, animationIndex: 0 }));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            setState(function (state) {
              return __chunk_3._extends({}, state, {
                rows: rows,
          ...
          case 12:
            ...
            setState(function (state) {
              ...
              return __chunk_3._extends({}, state, {
                heights: (_ref7 = [].concat(__chunk_3.toConsumableArray(state.heights))).splice.apply(_ref7, [0, animationNum].concat(__chunk_3.toConsumableArray(new Array(animationNum).fill(0))))
              });
            });
