...
var pie = {
  ...
  draw: function draw(_ref2, _ref3) {
    ...
    var connectPoint1 = (0, __chunk_6._util.getCircleRadianPoint)(rx, ry, or, endAngle).map(function (p) {
      return parseInt(p) + 0.5;
    });
    var connectPoint2 = (0, __chunk_6._util.getCircleRadianPoint)(rx, ry, ir, startAngle).map(function (p) {
      return parseInt(p) + 0.5;
    });
...
var agArc = {
  ...
  draw: function draw(_ref5, _ref6) {
    ...
    gradient = gradient.map(function (cv) {
      return (0, __chunk_7._color.getColorFromRgbValue)(cv);
    });
    ...
    for (var i = 0; i < gradientArcNum; i++) {
      ctx.beginPath();
      var startPoint = (0, __chunk_6._util.getCircleRadianPoint)(rx, ry, r, startAngle + angleGap * i);
      var endPoint = (0, __chunk_6._util.getCircleRadianPoint)(rx, ry, r, startAngle + angleGap * (i + 1));
      var color = (0, __chunk_6.util.getLinearGradientColor)(ctx, startPoint, endPoint, [gradient[i], gradient[i + 1]]);
...
(0, __chunk_7.lib.extendNewGraph)('pie', pie);
(0, __chunk_7.lib.extendNewGraph)('agArc', agArc);
(0, __chunk_7.lib.extendNewGraph)('numberText', numberText);
(0, __chunk_7.lib.extendNewGraph)('lineIcon', lineIcon);

exports._util2 = __chunk_6.util;
exports.require$$3 = __chunk_7.lib;
//# sourceMappingURL=chunk-4d511055.js.map
