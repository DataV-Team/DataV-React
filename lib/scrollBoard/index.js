...
var __chunk_1 = require('../chunk-77a38e55.js');
...
function calcAligns(mergedConfig, header) {
  ...
  return __chunk_6.util_2(aligns, align);
}
...
var ScrollBoard = function ScrollBoard(_ref3) {
  ...
  var stateRef = React.useRef(__chunk_2._extends({}, state, {
    rowsData: [],
    avgHeight: 0,
    animationIndex: 0
  }));
  ...
  function calcWidths(_ref4, rowsData) {
    ...
    return __chunk_6.util_2(widths, columnWidth);
  }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            setState(function (state) {
              return __chunk_2._extends({}, state, { rows: rows, heights: heights });
            });
          ...
          case 12:
            ...
            newHeights = [].concat(__chunk_2.toConsumableArray(heights));

            newHeights.splice.apply(newHeights, [0, animationNum].concat(__chunk_2.toConsumableArray(new Array(animationNum).fill(0))));

            Object.assign(stateRef.current, { animationIndex: animationIndex });
            setState(function (state) {
              return __chunk_2._extends({}, state, { heights: newHeights });
            });
  ...
  React.useEffect(onResize, [height]);

  var classNames = React.useMemo(function () {
    return __chunk_5.classnames('dv-scroll-board', className);
  }, [className]);
