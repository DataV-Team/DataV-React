...
function mergeOffset(_ref3, _ref4) {
  var _ref6 = __chunk_3.slicedToArray(_ref3, 2),
      x = _ref6[0],
      y = _ref6[1];

  var _ref5 = __chunk_3.slicedToArray(_ref4, 2),
      ox = _ref5[0],
      oy = _ref5[1];
...
var WaterLevelPond = function WaterLevelPond(_ref7) {
  var animationWave = function () {
    var _ref12 = __chunk_3.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  ...
  function init() {
    rendererRef.current = new __chunk_7.CRender(domRef.current);
  ...
  function calcDetails(_ref9) {
    ...
    var maxValue = Math.max.apply(Math, __chunk_3.toConsumableArray(data));
  ...
  function getWaveShapes(_ref10) {
    ...
    var _rendererRef$current$ = __chunk_3.slicedToArray(rendererRef.current.area, 2),
  ...
  var classNames = React.useMemo(function () {
    return __chunk_5.classnames('dv-water-pond-level', className);
  }, [className]);
