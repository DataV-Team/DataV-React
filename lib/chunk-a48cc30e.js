...
function useAutoResize(afterAutoResizeMixinInit, onResize) {
  ...
  var bindDomResizeCallback = React.useCallback(function () {
    domObserverRef.current = __chunk_1.observerDomResize(domRef.current, debounceSetWHFunRef.current);
  ...
  React.useEffect(function () {
    debounceSetWHFunRef.current = __chunk_1.debounce(setWH, 100);
...
//# sourceMappingURL=chunk-a48cc30e.js.map
