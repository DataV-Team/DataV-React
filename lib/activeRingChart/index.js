...
var ActiveRingChart = function ActiveRingChart(_ref) {
  ...
  function getOption(mergedConfig, activeIndex) {
    ...
    option = __chunk_2._extends({}, option, {
      series: option.series.reduce(function (prev, serie, index) {
        return index !== 0 ? [].concat(__chunk_2.toConsumableArray(prev), [serie]) : [].concat(__chunk_2.toConsumableArray(prev), [__chunk_2._extends({}, serie, {
                    ...
                    switch (_context.prev = _context.next) {
                      ...
                      case 5:
                        ...
                        setState(function (state) {
                          return __chunk_2._extends({}, state, { activeIndex: activeIndex });
                        });
