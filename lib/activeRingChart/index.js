...
var __chunk_8 = require('../chunk-de6d6f3c.js');
...
var ActiveRingChart = function ActiveRingChart(_ref) {
  ...
  React.useEffect(function () {
    // 第一次时初始化
    chartRef.current || (chartRef.current = new __chunk_8.Chart(domRef.current));
  ...
  var classNames = React.useMemo(function () {
    return __chunk_4.classnames('dv-active-ring-chart', className);
  }, [className]);
