...
function getControlPoint(_ref, _ref2, _ref3) {
  var _ref5 = __chunk_2.slicedToArray(_ref, 2),
      sx = _ref5[0],
      sy = _ref5[1];

  var _ref4 = __chunk_2.slicedToArray(_ref2, 2),
      ex = _ref4[0],
      ey = _ref4[1];
  ...
  var distance = __chunk_1.getPointDistance([sx, sy], [ex, ey]);
  ...
  do {
    dx += disDived;
    dy = my - k * mx + k * dx;
  } while (__chunk_1.getPointDistance([mx, my], [dx, dy]) < targetLength);
...
var FlyLineChart = function FlyLineChart(_ref6) {
  ...
  var _useAutoResize = __chunk_3.useAutoResize(calcData, calcData),
  ...
  function calcData() {
    ...
    var times = points.map(function (foo) {
      return __chunk_1.randomExtend.apply(undefined, __chunk_2.toConsumableArray(duration)) / 10;
    });
  ...
  function createFlylinePaths(mergedConfig) {
    ...
    if (relative) {
      ...
      points = points.map(function (_ref9) {
        var _ref10 = __chunk_2.slicedToArray(_ref9, 2),
            x = _ref10[0],
            y = _ref10[1];
