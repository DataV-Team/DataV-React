...
var keywords = __chunk_5.createCommonjsModule(function (module, exports) {
...
__chunk_5.unwrapExports(keywords);
...
var _keywords = __chunk_6._interopRequireDefault(keywords);
...
var bezierCurveToPolyline_1 = __chunk_5.createCommonjsModule(function (module, exports) {
...
__chunk_5.unwrapExports(bezierCurveToPolyline_1);
...
var polylineToBezierCurve_1 = __chunk_5.createCommonjsModule(function (module, exports) {
...
__chunk_5.unwrapExports(polylineToBezierCurve_1);

var lib$1 = __chunk_5.createCommonjsModule(function (module, exports) {
...
var _polylineToBezierCurve = __chunk_6._interopRequireDefault(polylineToBezierCurve_1);
...
__chunk_5.unwrapExports(lib$1);

var canvas = __chunk_5.createCommonjsModule(function (module, exports) {
...
__chunk_5.unwrapExports(canvas);
var canvas_1 = canvas.drawPolylinePath;
var canvas_2 = canvas.drawBezierCurvePath;

var graphs_1 = __chunk_5.createCommonjsModule(function (module, exports) {
...
var _bezierCurve2 = __chunk_6._interopRequireDefault(lib$1);
...
var circle = {
  ...
  hoverCheck: function hoverCheck(position, _ref4) {
    ...
    var rx = shape.rx,
        ry = shape.ry,
        r = shape.r;
    return (0, __chunk_6._util.checkPointIsInCircle)(position, rx, ry, r);
  },
...
var ellipse = {
  ...
  hoverCheck: function hoverCheck(position, _ref11) {
    ...
    var distance = (0, __chunk_6._util.getTwoPointDistance)(position, leftFocusPoint) + (0, __chunk_6._util.getTwoPointDistance)(position, rightFocusPoint);
    return distance <= 2 * a;
  },
...
var rect = {
  ...
  hoverCheck: function hoverCheck(position, _ref18) {
    ...
    var x = shape.x,
        ...
        w = shape.w,
        h = shape.h;
    return (0, __chunk_6._util.checkPointIsInRect)(position, x, y, w, h);
  },
...
var ring = {
  ...
  hoverCheck: function hoverCheck(position, _ref25) {
    ...
    var distance = (0, __chunk_6._util.getTwoPointDistance)(position, [rx, ry]);
...
var arc = {
  ...
  hoverCheck: function hoverCheck(position, _ref32) {
    ...
    return !(0, __chunk_6._util.checkPointIsInSector)(position, rx, ry, insideRadius, startAngle, endAngle, clockWise) && (0, __chunk_6._util.checkPointIsInSector)(position, rx, ry, outsideRadius, startAngle, endAngle, clockWise);
  },
...
var sector = {
  ...
  hoverCheck: function hoverCheck(position, _ref39) {
    ...
    var rx = shape.rx,
        ...
        endAngle = shape.endAngle,
        clockWise = shape.clockWise;
    return (0, __chunk_6._util.checkPointIsInSector)(position, rx, ry, r, startAngle, endAngle, clockWise);
  },
...
var regPolygon = {
  ...
  draw: function draw(_ref44, _ref45) {
    ...
    if (!cache.points || cache.rx !== rx || cache.ry !== ry || cache.r !== r || cache.side !== side) {
      var _points = (0, __chunk_6._util.getRegularPolygonPoints)(rx, ry, r, side);
  ...
  hoverCheck: function hoverCheck(position, _ref46) {
    ...
    var points = cache.points;
    return (0, __chunk_6._util.checkPointIsInPolygon)(position, points);
  },
...
var polyline = {
  ...
  draw: function draw(_ref53, _ref54) {
    ...
    var points = shape.points,
        close = shape.close;
    if (lineWidth === 1) points = (0, __chunk_6._util.eliminateBlur)(points);
    (0, canvas.drawPolylinePath)(ctx, points);
  ...
  hoverCheck: function hoverCheck(position, _ref55) {
    ...
    if (close) {
      ...
      return (0, __chunk_6._util.checkPointIsNearPolyline)(position, points, lineWidth);
    }
  },
...
var smoothline = {
  ...
  draw: function draw(_ref62, _ref63) {
    ...
    if (!cache.points || cache.points.toString() !== points.toString()) {
      ...
      Object.assign(cache, {
        points: (0, __chunk_6._util.deepClone)(points, true),
  ...
  hoverCheck: function hoverCheck(position, _ref64) {
    ...
    if (close) {
      return (0, __chunk_6._util.checkPointIsInPolygon)(position, hoverPoints);
    } else {
      return (0, __chunk_6._util.checkPointIsNearPolyline)(position, hoverPoints, lineWidth);
    }
  },
...
__chunk_5.unwrapExports(graphs_1);
...
var runtime_1 = __chunk_5.createCommonjsModule(function (module) {
/**
...
var style_class = __chunk_5.createCommonjsModule(function (module, exports) {
...
var _classCallCheck2 = __chunk_6._interopRequireDefault(classCallCheck);
...
Style.prototype.getStyle = function () {
  var clonedStyle = (0, __chunk_6._util.deepClone)(this, true);
  this.colorProcessor(clonedStyle, true);
  return clonedStyle;
};
});

__chunk_5.unwrapExports(style_class);

var curves = __chunk_5.createCommonjsModule(function (module, exports) {
...
__chunk_5.unwrapExports(curves);
...
var lib$2 = __chunk_5.createCommonjsModule(function (module, exports) {
...
var _curves = __chunk_6._interopRequireDefault(curves);
...
__chunk_5.unwrapExports(lib$2);
var lib_1$1 = lib$2.transition;
var lib_2$1 = lib$2.injectNewCurve;

var graph_class = __chunk_5.createCommonjsModule(function (module, exports) {
...
var _regenerator = __chunk_6._interopRequireDefault(regenerator);

var _asyncToGenerator2 = __chunk_6._interopRequireDefault(asyncToGenerator);
...
var _style = __chunk_6._interopRequireDefault(style_class);

var _transition = __chunk_6._interopRequireDefault(lib$2);
...
var Graph = function Graph(graph, config) {
  ...
  config = (0, __chunk_6._util.deepClone)(config, true);
  var defaultConfig = {
    /**
...
Graph.prototype.hoverCheckProcessor = function (position, _ref) {
  ...
  if (graphCenter) {
    if (rotate) position = (0, __chunk_6._util.getRotatePointPos)(-rotate, position, graphCenter);
    if (scale) position = (0, __chunk_6._util.getScalePointPos)(scale.map(function (s) {
      return 1 / s;
    }), position, graphCenter);
    if (translate) position = (0, __chunk_6._util.getTranslatePointPos)(translate.map(function (v) {
      return v * -1;
    }), position);
  }

  if (hoverRect) return __chunk_6._util.checkPointIsInRect.apply(void 0, [position].concat((0, _toConsumableArray2["default"])(hoverRect)));
...
Graph.prototype.attr = function (attrName) {
  ...
  if (isObject) change = (0, __chunk_6._util.deepClone)(change, true);
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            change = (0, __chunk_6._util.deepClone)(change, true);
...
__chunk_5.unwrapExports(graph_class);

var crender_class = __chunk_5.createCommonjsModule(function (module, exports) {
...
var _defineProperty2 = __chunk_6._interopRequireDefault(defineProperty);

var _toConsumableArray2 = __chunk_6._interopRequireDefault(__chunk_6.require$$1);

var _classCallCheck2 = __chunk_6._interopRequireDefault(classCallCheck);

var _color = __chunk_6._interopRequireDefault(lib);

var _bezierCurve = __chunk_6._interopRequireDefault(lib$1);



var _graphs = __chunk_6._interopRequireDefault(graphs_1);

var _graph = __chunk_6._interopRequireDefault(graph_class);
...
CRender.prototype.clone = function (graph) {
  ...
  clonedGraph = (0, __chunk_6._util.deepClone)(clonedGraph, true);
  return this.add(clonedGraph);
};
});

__chunk_5.unwrapExports(crender_class);

var lib$3 = __chunk_5.createCommonjsModule(function (module, exports) {
...
var _crender = __chunk_6._interopRequireDefault(crender_class);
...
var CRender = __chunk_5.unwrapExports(lib$3);

exports.lib = lib$3;
exports._color = lib;
exports.require$$2 = classCallCheck;
exports.require$$0 = defineProperty;
exports.require$$4 = lib$1;
exports.CRender = CRender;
//# sourceMappingURL=chunk-313ce2cd.js.map
