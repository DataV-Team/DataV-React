...
var DigitalFlop = function DigitalFlop(_ref) {
  ...
  function init() {
    rendererRef.current = new __chunk_6.CRender(domRef.current);
  ...
  var getMergedConfig = function getMergedConfig() {
    return __chunk_5.util_2(__chunk_5.util_1(defaultConfig, true), config || {});
  };
  ...
  var classNames = React.useMemo(function () {
    return __chunk_4.classnames('dv-digital-flop', className);
  }, [className]);
